...
#ifndef __INCLUDE_DAHUA_EFS_WEB2CS_GET_CLUSTER_NETWORK_MESSAGE_H__
#define __INCLUDE_DAHUA_EFS_WEB2CS_GET_CLUSTER_NETWORK_MESSAGE_H__
...
//协议名   WEB2CS_GET_CLUSTER_NETWORK_MESSAGE
//发起方   目录服务器
//接收方   运维
//描述     响应是否设置成功
...
class CWeb2csGetClusterNetworkMessage : public CPacketBase
{
public:
    CWeb2csGetClusterNetworkMessage( );
    CWeb2csGetClusterNetworkMessage( uint32_t seq );
    ~CWeb2csGetClusterNetworkMessage( );
...
class CResWeb2csGetClusterNetworkMessage : public CPacketBase
{
public:
    CResWeb2csGetClusterNetworkMessage( );
    CResWeb2csGetClusterNetworkMessage( uint32_t seq );
    ~CResWeb2csGetClusterNetworkMessage( );
...
typedef Memory::TSmartObjectPtr<CWeb2csGetClusterNetworkMessage> TWeb2csGetClusterNetworkMsgPtr;
typedef Memory::TSmartObjectPtr<CResWeb2csGetClusterNetworkMessage> TResWeb2csGetClusterNetworkMsgPtr;
TPacketBasePtr newCWeb2csGetClusterNetworkMessage(  );
TPacketBasePtr newCResWeb2csGetClusterNetworkMessage(  );

} // namespace EFS
} // namespace Dahua

#endif //__INCLUDE_DAHUA_EFS_WEB2CS_GET_CLUSTER_NETWORK_MESSAGE_H__
