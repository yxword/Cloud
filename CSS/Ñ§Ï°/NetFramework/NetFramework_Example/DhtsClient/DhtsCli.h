...
//
//
#ifndef __INCLUDED_DHTS_CLIENT_H__
#define __INCLUDED_DHTS_CLIENT_H__
...
class CDhtsCli : public CNetHandler
{
public:
	CDhtsCli();
	virtual ~CDhtsCli();
public:
	int StartSession( CSockAddr & addr , bool initial);
