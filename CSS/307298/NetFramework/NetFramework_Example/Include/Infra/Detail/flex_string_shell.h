...
private:
    ...
    {
		typedef typename std::iterator_traits<InputIterator>::iterator_category iterator_category;	// πÊ±‹VC6±‡“Î¥ÌŒÛ
        ...
        FwdIterator s1, FwdIterator s2, std::forward_iterator_tag)
    {
        ...
        if(IsAliasedRange(s1, s2))
        {
			...
			typedef typename std::iterator_traits<FwdIterator>::iterator_category iterator_category;	// πÊ±‹VC6±‡“Î¥ÌŒÛ
...
#define DAHUA_FLEX_STRING	Dahua::Infra::flex_string
