...
Report: $(TARGET)
	-rm -rf Reports/*
	./lcov/usr/bin/lcov -b .. -z -d ../Compile/ --ignore-errors source
	-./$^
	./lcov/usr/bin/lcov -b .. -c -o Reports/dummy0  -d ../Compile/ --ignore-errors source
	./lcov/usr/bin/lcov -r Reports/dummy0 *nclude/* *Test/* *.h* -o Reports/dummy1 
	./lcov/usr/bin/genhtml Reports/dummy1 -o Reports/$@ --legend -t StreamApp
